                      ...
                      const Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 4),
                            Text(
                              'Yeni görselden ana renkler tespit ediliyor',
                              style: TextStyle(
                                fontSize: 12,
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              '${_detectedColors.length} renk tespit edildi. Silmek için ✕ işaretine tıklayın.',
                              style: TextStyle(
                                fontSize: 12,
                                color: Colors.grey[600],
                  ...
                  child: Center(
                    child: Column(
                      children: [
                        ...
                        const SizedBox(height: 8),
                        Text(
                          'Renk analizi için yeni bir resim seçin',
                          style: TextStyle(
                            color: Colors.grey[600],
